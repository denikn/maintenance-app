...
function delayRender(importFactory, loadingComponent = <LinearProgress />) {
    return props => {
        const BaseComponent = onDemand.loadDefault(importFactory, {
...
const routes = (
    <Router history={hashHistory}>
        <Route path="/" component={App}>
            ...
            <Route
                path="list/all"
                component={delayRender(() =>
                    System.import(
                        './MenuCards/MenuCardsForAllSections.component'
                    )
                )}
            ...
            <Route path="list/:groupName">
                <IndexRoute
                    component={delayRender(() =>
                        System.import(
                            './MenuCards/MenuCardsForSection.component'
                        )
                    )}
                    onEnter={initState}
                />
                <Route
                    ...
                    component={delayRender(() =>
                        System.import(
                            './List/organisation-unit-list/OrganisationUnitList.component.js'
                        )
                    )}
                ...
                <Route
                    ...
                    component={delayRender(() =>
                        System.import(
                            './OrganisationUnitLevels/OrganisationUnitLevels.component'
                        )
                    )}
                ...
                <Route
                    path=":modelType"
                    component={delayRender(() =>
                        System.import('./List/List.component')
                    )}
                    onEnter={loadList}
                />
            </Route>
            <Route path="edit/:groupName">
                <Route
                    ...
                    component={delayRender(() =>
                        System.import(
                            './EditModel/EditModelContainer.component'
                        )
                    )}
                ...
                <Route
                    ...
                    component={delayRender(() =>
                        System.import('./EditModel/EditOptionSet.component')
                    )}
                ...
                <Route
                    ...
                    component={delayRender(() =>
                        System.import(
                            './EditModel/event-program/EditProgram.component'
                        )
                    )}
                ...
                <Route
                    ...
                    component={delayRender(() =>
                        System.import(
                            './EditModel/program-indicator/EditProgramIndicator'
                        )
                    )}
                    onEnter={createLoaderForSchema(
                        'programIndicator',
                ...
                <Route
                    ...
                    component={delayRender(() =>
                        System.import(
                            './EditModel/EditDataSetSections.component'
                        )
                    )}
                    onEnter={loadObject}
                    hideSidebar
                ...
                <Route
                    ...
                    component={delayRender(() =>
                        System.import('./EditModel/EditDataEntryForm.component')
                    )}
                    onEnter={loadObject}
                    hideSidebar
                    disableTabs
            ...
            <Route
                ...
                component={delayRender(() =>
                    System.import('./EditModel/EditModelContainer.component')
                )}
                onEnter={cloneObject}
                hideSidebar
                disableTabs
            ...
            <Route
                path="group-editor"
                component={delayRender(() =>
                    System.import('./GroupEditor/GroupEditor.component')
                )}
                onEnter={initState}
            />
            <Route
                ...
                component={delayRender(() =>
                    System.import('./OrganisationUnitHierarchy')
                )}
