...
class EditDataEntryForm extends React.Component {
    constructor(props, context) {
        ...
        Promise.all([
            context.d2.models.dataSets.get(props.params.modelId, {
                fields:
                    'id,displayName,dataEntryForm[id,style,htmlCode],indicators[id,displayName]',
            }),
            ...
            const formHtml = dataSet.dataEntryForm
                ? this.processFormData(dataSet.dataEntryForm)
                : '';
    ...
    handleSaveClick() {
        ...
        this.context.d2.Api.getApi()
            ...
            .then(() => {
                ...
                snackActions.show({
                    message: this.getTranslation('form_saved'),
                });
            ...
            .catch(e => {
                ...
                snackActions.show({
                    message: `${this.getTranslation('failed_to_save_form')}${
                        e.message ? `: ${e.message}` : ''
                    }`,
        ...
        snackActions.show({
            ...
            onActionTouchTap: () => {
                this.context.d2.Api.getApi()
                    ...
                    .then(() => {
                        snackActions.show({
                            message: this.getTranslation('form_deleted'),
                        });
                        goToRoute('list/dataSetSection/dataSet');
                    })
                    .catch(err => {
    ...
    generateHtml(id, styleAttr, disabledAttr) {
        ...
        const disabled =
            disabledAttr || this.state.insertGrey ? ' disabled="disabled"' : '';
    ...
    processFormData(formData) {
        const inHtml = formData.hasOwnProperty('htmlCode')
            ? formData.htmlCode
            : formData || '';
        let outHtml = '';
    ...
    renderPaletteSection(keySet, label) {
        ...
        const cellClass =
            label === this.state.expand ? 'cell expanded' : 'cell';
                ...
                <div className="items">
                    {filteredItems
                        ...
                        .map(key => {
                            ...
                            const isActive =
                                this.state.usedIds.indexOf(key) === -1;
    ...
    renderPalette() {
        ...
        return (
            <div
                ...
                style={{ width: this.state.paletteWidth }}
            >
