...
describe('Assign data elements epics', () => {
    ...
    describe('adding new data elements to the program stage', () => {
        ...
        test('should add multiple programStageDataElement', done => {
            ...
            epic(createActionStreamFor(action)).subscribe(() => {
                ...
                const newlyAddedDataElementTwo = store.getState()
                    .programStages[0].programStageDataElements[3];
    ...
    describe('editing programStageDataElement', () => {
        test('should update the programStageDataElement with the new values', done => {
            const action = {
            ...
            epic(createActionStreamFor(action)).subscribe(() => {
                const editedDataElement = store.getState().programStages[0]
                    .programStageDataElements[0];
