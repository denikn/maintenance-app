...
describe('Event Program actions', () => {
    ...
    describe('for loading a event program', () => {
        ...
        test('should create the EVENT_PROGRAM_LOAD action', () => {
            expect(actions.loadEventProgram()).toEqual({
                type: actions.EVENT_PROGRAM_LOAD,
                payload: undefined
            })
        })

        test('should create the EVENT_PROGRAM_LOAD_SUCCESS action', () => {
            expect(actions.loadEventProgramSuccess()).toEqual({
                type: actions.EVENT_PROGRAM_LOAD_SUCCESS,
                payload: undefined
            })
        })

        test('should create the EVENT_PROGRAM_LOAD_SUCCESS action', () => {
            expect(actions.loadEventProgramFailure()).toEqual({
                type: actions.EVENT_PROGRAM_LOAD_ERROR,
                payload: undefined
            })
        })
    })
    ...
    describe('for saving an event program', () => {
        ...
        test('should create the save success action when calling saveEventProgramSuccess', () => {
            const expectedAction = {
        ...
        test('should create the save error action when calling saveEventProgramError', () => {
            const expectedAction = {
