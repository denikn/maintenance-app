...
import {
    getStageSectionsById,
    getProgramStageById
} from '../tracker-program/program-stages/selectors'
...
const setSortOrderToIndex = models =>
...
const addProgramStageSection = store => action$ =>
    action$
        ...
        .map(([d2, action]) => {
            ...
            const newSection = d2.models.programStageSection.create({
                id: generateUid(),
                dataElements: []
            })
            ...
            if (!programStageSections) {
                programStageSections = state.programStageSections[
                    programStageId
                ] = []
            }
