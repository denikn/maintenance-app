...
export const NOTIFICATION_STAGE_REMOVE_SUCCESS =
    'NOTIFICATION_STAGE_REMOVE_SUCCESS';
export const NOTIFICATION_STAGE_REMOVE_ERROR =
...
export const NOTIFICATION_STAGE_SAVE_SUCCESS =
...
export const NOTIFICATION_STAGE_SET_PROGRAM_STAGE =
    'NOTIFICATION_STAGE_SET_PROGRAM_STAGE';

export const NOTIFICATION_PROGRAM_SAVE = 'NOTIFICATION_PROGRAM_SAVE';
export const NOTIFICATION_PROGRAM_SAVE_SUCCESS =
    'NOTIFICATION_PROGRAM_SAVE_SUCCESS';
export const NOTIFICATION_PROGRAM_SAVE_ERROR =
    'NOTIFICATION_PROGRAM_SAVE_ERROR';
export const NOTIFICATION_PROGRAM_REMOVE = 'NOTIFICATION_PROGRAM_REMOVE';
export const NOTIFICATION_PROGRAM_REMOVE_SUCCESS =
    'NOTIFICATION_PROGRAM_REMOVE_SUCCESS';
export const NOTIFICATION_PROGRAM_REMOVE_ERROR =
    'NOTIFICATION_PROGRAM_REMOVE_ERROR';

export const removeStageNotification = model => ({
    type: NOTIFICATION_STAGE_REMOVE,
    payload: model,
});
...
export const removeProgramNotification = model => ({
    type: NOTIFICATION_PROGRAM_REMOVE,
    payload: model,
});
...
export const setAddModel = (notificationType = 'PROGRAM_STAGE_NOTIFICATION') =>
    createActionCreator(NOTIFICATION_SET_ADD_MODEL)({ notificationType });

export const setSelectedProgramStage = stageId =>
    createActionCreator(NOTIFICATION_STAGE_SET_PROGRAM_STAGE)({ stageId });

export const setStageNotificationValue = (property, value) => ({
    type: NOTIFICATION_SET_VALUE,
    payload: { property, value },
});
export const saveStageNotification = model => ({
    type: NOTIFICATION_STAGE_SAVE,
    payload: model,
});
...
export const saveProgramNotification = model =>
    createActionCreator(NOTIFICATION_PROGRAM_SAVE)({ model });
