    ...
    handleEditorChanged = editorData => {
        ...
        this.setState(
            ...
            () => {
                ...
                if (
                    !this.state.dataEntryForm ||
                    this.state.dataEntryForm.htmlCode !== outHtml
                ) {
                ...
                <div className="palette">
                    ...
                    <div className="elements">
                        <PurePaletteSection
                            ...
                            expandClick={() => {
                                this.setState({ expand: 'data_elements' })
                            }}
...
const mapDispatchToPropsForProgramStage = (dispatch, { programStage }) =>
    bindActionCreators(
        {
...
const programStageDataEntryForm = compose(
    ...
    connect(
        undefined,
        mapDispatchToPropsForProgramStage
    )
)
