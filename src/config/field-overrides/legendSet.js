...
const LoadableLegendComponent = LoadableComponent({
    loader: () => import('d2-ui/lib/legend/Legend.component'),
});
...
class LegendsField extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <LoadableLegendComponent
                    items={legends}
                    onItemsChange={this.updateLegends}
                />
