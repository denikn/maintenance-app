const fieldOrderByName = new Map([
    ...
    [
        'dataElementGroup',
        ['name', 'shortName', 'code', 'description', 'dataElements'],
    ],
    [
        'dataElementGroupSet',
        [
    ...
    ['indicatorType', ['name', 'factor']],
    [
        'indicatorGroupSet',
        ['name', 'description', 'compulsory', 'indicatorGroups'],
    ],
    ...
    ['organisationUnitLevel', ['name', 'offlineLevels']],
    ['constant', ['name', 'shortName', 'code', 'description', 'value']],
    [
        'attribute',
        [
            'name',
    ...
    ['optionSet', ['name', 'code', 'description', 'valueType']],
    ['legendSet', ['name', 'code', 'legends']],
    [
        'eventProgram',
        [
            'name',
    ...
    [
        ...
        ['name', 'shortName', 'code', 'description', 'trackedEntityAttributes'],
    ],
    ['relationshipType', ['name', 'code', 'aIsToB', 'bIsToA']],
    [
        'trackedEntityType',
        [
            'name',
    ...
    ['programIndicatorGroup', ['name', 'code', 'programIndicators']],
    [
        'validationRule',
        [
            'name',
    ...
    [
        'validationRuleGroup',
        ['name', 'shortName', 'code', 'description', 'validationRules'],
    ],
    [
        'predictor',
        [
    ...
    ['dataApprovalLevel', ['name', 'orgUnitLevel', 'categoryOptionGroupSet']],
    ['dataApprovalWorkflow', ['name', 'periodType', 'dataApprovalLevels']],
]);
